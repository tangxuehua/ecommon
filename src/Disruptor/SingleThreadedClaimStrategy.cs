...
namespace Disruptor
{
    ...
    public sealed class SingleThreadedClaimStrategy : IClaimStrategy
    {
        ...
        private VolatileType.PaddedLong _claimSequence = new VolatileType.PaddedLong(Sequencer.InitialCursorValue);
        private VolatileType.PaddedLong _minGatingSequence = new VolatileType.PaddedLong(Sequencer.InitialCursorValue);
